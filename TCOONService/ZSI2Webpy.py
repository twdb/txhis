...
_ZSISERVICECLS = WaterOneFlowServiceImpl
class _SERVICECLASS: pass
#customize this to real WSURL
WSURLPREFIX = "/WMLWS"

urls = ("/%s" % WS_PATH, _SERVICECLASS.__name__,
        )


app=web.application(urls, globals())

class GenericSOAPClass:
    ...
    def GET(self):
        ...
        if self.path.lower().endswith("?wsdl"):
            ...
            return ("Service not found [%s]." % self.path)
    def POST(self):
...
_SERVICECLASS = GenericSOAPClass
